...
/* ISR patch code for PSoC3 ES2*/
        ...
        #include <intrins.h>
        #define ADC_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
...
#if(ADC_DEFAULT_CHARGE_PUMP_CLOCK)
...
#endif /* ADC_DEFAULT_CHARGE_PUMP_CLOCK */
...
#define ADC_EN_PRESA                   (0x80u) 
#define ADC_EN_PRESD                   (0x40u)
