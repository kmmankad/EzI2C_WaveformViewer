...
{
    if (ADC_Ext_CP_Clk_CLKEN & ADC_Ext_CP_Clk_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void ADC_Ext_CP_Clk_SetModeRegister(uint8 clkMode) 
{
    ADC_Ext_CP_Clk_MOD_SRC |= clkMode & ADC_Ext_CP_Clk_MODE_MASK;
}
...
*
*******************************************************************************/
void ADC_Ext_CP_Clk_ClearModeRegister(uint8 clkMode) 
{
    ADC_Ext_CP_Clk_MOD_SRC &= ~clkMode | ~ADC_Ext_CP_Clk_MODE_MASK;
}
...
{
    return ADC_Ext_CP_Clk_MOD_SRC & ADC_Ext_CP_Clk_MODE_MASK;
}
...
void ADC_Ext_CP_Clk_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        ADC_Ext_CP_Clk_MOD_SRC =
            (ADC_Ext_CP_Clk_MOD_SRC & ~ADC_Ext_CP_Clk_SRC_SEL_MSK) | clkSource;
    }
